"""Add age/gender/education to mp_profiles; add avg columns to mp_raw_data
...
def upgrade() -> None:
    ...
    op.add_column("mp_profiles", sa.Column("education", sa.String(length=255), nullable=True))
