function InfoIcon({ note }) {
  return (
    <span className="relative group/info inline-flex items-center ml-1 cursor-pointer">
      ...
      <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-52 rounded-xl bg-slate-800 px-3 py-2 text-xs text-white opacity-0 group-hover/info:opacity-100 transition-opacity pointer-events-none z-50 shadow-lg">
        {note}
